        ...
        <div className="">
          <div className="flex items-center justify-between gap-3 w-full">
            ...
            <div className="flex items-center justify-center flex-shrink-0">
              ...
              {/* Contact Details */}
              <div className="flex flex-wrap justify-center items-center gap-0 text-xs text-right mt-1">
                {/* 📞 Mobile Number — hide below 450px */}
                <div className="hidden min-[606px]:flex px-6 items-center gap-1 border-r border-orange-600">
                    <svg
                ...
                {/* Email */}
                <div className="px-6 flex items-center gap-1 min-[868px]:border-r border-orange-600">
                  <svg
                  className="w-3.5 h-3.5 text-gray-600 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                ...
                {/* Clinic Address */}
                <div className="hidden min-[868px]:flex items-center gap-1 px-6">
                  <svg
                  className="w-3.5 h-3.5 text-gray-600 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
